...
{
public:
    WebSocketServer(uint16_t port, uv_loop_t* loop, Logger* logger);
    WebSocketServer(uint16_t port, uv_loop_t* loop, const std::string& key_file, const std::string& cert_file, Logger* logger);
