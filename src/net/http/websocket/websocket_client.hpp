...
{
public:
    WebSocketClient(uv_loop_t* loop, const std::string& hostname, uint16_t port, const std::string& subpath, bool ssl_enable, Logger* logger, WebSocketConnectionCallBackI* conn_cb);
